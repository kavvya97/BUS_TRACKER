...
function requestLocation2(number){
  ...
  // function createInfoWindow(item, stop, dept, arrival) {
//     var infoWindowId = "infoWindow_" + item.replace(/\s/g, '_');
//     // var infoWindowDiv = document.getElementById(infoWindowId);

//     var stopLabel = document.createElement('label');
//     infoWindowDiv.appendChild(stopLabel);

//     var deptLabel = document.createElement('Label');
//     infoWindowDiv.appendChild(deptLabel);

//     var arrivalLabel = document.createElement('label');
//     infoWindowDiv.appendChild(arrivalLabel);

//     stopLabel.innerText = stop;
//     deptLabel.innerText = dept;
//     arrivalLabel.innerText = arrival;
// }
...
//for direction service and putting routes on the map
...
//     });
// }
//     var prevSlot,currentSlot,nextSlot;
...
//            var displaytimeTable = document.getElementById("displayLocation");
//            var tms=JSON.parse(this.responseText);
//            var itemsInTms=tms.time;
//            for(index in itemsInTms)
//            {
...
//                displaytimeTable.appendChild(itemRow);

//                var timeDisplay = document.createElement('label');
//                itemRow.appendChild(timeDisplay);
               

//             //assuming nearest stop is chrompet
//                if(time > item.start && time < item.last)
//                {
//                      if(time <  item.timing.Chrompet)
//                      {
//                          currentSlot = item.timing.chrompet;
//                          timeDisplay.innerText = currentSlot;
//                      }
//                     //  if(time > item.timing.Chrompet)
//                     //  {
//                     //      nextSlot = 
...
//       busRoutePath.setMap(map);
// }
 // document.getElementsByClassName("searchTextContainer")[0].style.backgroundColor="#3F7EE8";
    // document.getElementById("searchResultContainer").style.visibility="visible";
    // document.getElementById("searchResultContainer").style.backgroundColor="white";
    // styles: [
